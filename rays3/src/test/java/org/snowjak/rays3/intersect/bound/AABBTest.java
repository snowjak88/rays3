...
public class AABBTest {
	...
	public void testAABBAABBListOfTransform() {
		...
		AABB unTransformed = new AABB(new Point(0, 0, 0), new Point(1, 2, 0));
		AABB transformed = new AABB(unTransformed, Arrays.asList(new RotationTransform(Vector.K, 90d)));
	...
	public void testAABBCollectionOfPointListOfTransform() {
		...
		AABB transformed = new AABB(Arrays.asList(new Point(0, 0, 0), new Point(1, 2, 0)),
				Arrays.asList(new RotationTransform(Vector.K, -90d)));
	...
	public void testAABBCollectionOfPoint() {
		...
		AABB aabb = new AABB(
				Arrays.asList(new Point(0, 0, 0), new Point(-1, 0, 3), new Point(1, -2, 0), new Point(1, 2, -3)));
	...
	public void testUnion() {
		...
		AABB aabb1 = new AABB(new Point(-1, -1, -1), new Point(0, 0, 0)),
				aabb2 = new AABB(new Point(-1, 0, -1), new Point(2, 2, 2));
	...
	public void testIsIntersecting() {
		...
		Ray rayMiss = new Ray(new Point(-1, -1, -5), new Vector(0, 0, 1));
		Ray rayHit = new Ray(new Point(1, 1, 1), new Vector(0, 0, 1));
